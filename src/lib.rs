...
#[derive(Debug)]
pub struct HashNodeProcessor {
    verbose: bool,
    processed_count: usize,
}

impl HashNodeProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting HashNode processing");
    
    let mut processor = HashNodeProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = HashNodeProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = HashNodeProcessor::new(false);
